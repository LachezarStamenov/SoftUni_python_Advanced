# There is a circle road with N petrol pumps. The petrol pumps are numbered 0 to (N−1) (both inclusive). For each petrol
# pump, you will receive two pieces of information (separated by a single space):
